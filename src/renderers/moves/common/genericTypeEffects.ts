 ...
 */
export function drawSolarBeamEffect(ctx: any, start: { x: number; y: number }, target: { x: number; y: number }, angle: number, dx: number, dy: number) {
 ...
 */
export function drawDrainEffect(ctx: any, user: { x: number; y: number }, target: { x: number; y: number }, type: string) {
 ...
 */
export function drawHyperBeamEffect(ctx: any, start: { x: number; y: number }, target: { x: number; y: number }, angle: number, dx: number, dy: number) {
 ...
 */
export function drawElectricEffect(ctx: any, start: { x: number; y: number }, target: { x: number; y: number }, isSpecial: boolean) {
 ...
 */
export function drawFireEffect(ctx: any, start: { x: number; y: number }, target: { x: number; y: number }, isSpecial: boolean) {
 ...
 */
export function drawWaterEffect(ctx: any, start: { x: number; y: number }, target: { x: number; y: number }, isSpecial: boolean) {
 ...
 */
export function drawIceEffect(ctx: any, start: { x: number; y: number }, target: { x: number; y: number }, isSpecial: boolean) {
 ...
 */
export function drawSlashEffect(ctx: any, target: { x: number; y: number }, type: string) {
 ...
 */
export function drawShadowBallEffect(ctx: any, start: { x: number; y: number }, target: { x: number; y: number }, angle: number) {
 ...
 */
export function drawGrassEffect(ctx: any, start: { x: number; y: number }, target: { x: number; y: number }) {
  for (let i = 0; i < 8; i++) {
 ...
 */
export function drawPsychicEffect(ctx: any, target: { x: number; y: number }) {
 ...
 */
export function drawPoisonEffect(ctx: any, start: { x: number; y: number }, target: { x: number; y: number }) {
  for (let i = 0; i < 6; i++) {
 ...
 */
export function drawRockGroundEffect(ctx: any, target: { x: number; y: number }) {
 ...
 */
export function drawFlyingEffect(ctx: any, target: { x: number; y: number }) {
  for (let i = 0; i < 3; i++) {
 ...
 */
export function drawGhostDarkEffect(ctx: any, target: { x: number; y: number }) {
 ...
 */
export function drawDragonEffect(ctx: any, start: { x: number; y: number }, target: { x: number; y: number }) {
 ...
 */
export function drawSteelEffect(ctx: any, target: { x: number; y: number }) {
 ...
 */
export function drawFairyEffect(ctx: any, target: { x: number; y: number }) {
 ...
 */
export function drawPhysicalImpactEffect(ctx: any, target: { x: number; y: number }) {
