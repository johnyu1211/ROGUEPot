    ...
    act1Frames = [
      ...
      if (isTurn1Launch) {
        ...
        act1Frames = [
          ...
          // 2. High Sky Gliding Cutscene (66ms x 8 = 528ms)
          {
            delay: 66,
            pOffset: { x: -5, y: -8 },
            eOffset: { x: -5, y: -8 },
          ...
          },
          {
            ...
            pOffset: { x: -3, y: 6 },
            eOffset: { x: -3, y: 6 },
            pScale: isP1 ? { x: 0.94, y: 1.06 } : undefined,
            eScale: !isP1 ? { x: 0.94, y: 1.06 } : undefined,
            pRot: isP1 ? 0.02 : 0,
            eRot: !isP1 ? 0.02 : 0,
            isHighSkyCutscene: true,
            isAttackerPlayer: isP1,
      ...
      if (isTurn1Launch) {
        ...
        act2Frames = [
          ...
          },
          {
            ...
            pOffset: { x: -3, y: 6 },
            eOffset: { x: -3, y: 6 },
            pScale: isP2 ? { x: 0.94, y: 1.06 } : undefined,
            eScale: !isP2 ? { x: 0.94, y: 1.06 } : undefined,
            pRot: isP2 ? 0.02 : 0,
            eRot: !isP2 ? 0.02 : 0,
            isHighSkyCutscene: true,
            isAttackerPlayer: isP2,
