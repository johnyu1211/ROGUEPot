  ...
  if (isStatusMove1) {
    ...
    act1Frames = [
      ...
      if (isTurn1Launch) {
        ...
        // Turn 2: 15 FPS Looming Target Shadow -> High Sky Gliding -> Descending Dive-Bomb (Shaking & Expanding) -> Ground Slam Impact
        act1Frames = [
          // 1. Looming Shadow on Field Target (66ms x 3 = 200ms)
          // Attacker is in sky (hidden), small shadow appears over target and grows larger
          {
            delay: 66,
            pOffset: isP1 ? { x: 0, y: -9999 } : { x: 0, y: 0 },
            eOffset: !isP1 ? { x: 0, y: -9999 } : { x: 0, y: 0 },
            ...
            hidePShadow: isP1,
            hideEShadow: !isP1,
            loomingShadow: { offsetY: -55, w: 16, h: 6, alpha: 0.40 },
          ...
          },
          {
            ...
            hidePShadow: isP1,
            hideEShadow: !isP1,
            loomingShadow: { offsetY: -25, w: 36, h: 12, alpha: 0.65 },
            isHighSkyCutscene: false,
            isAttackerPlayer: isP1,
            showEffect: false,
            hitFlash: false,
          ...
          },
          {
            ...
            hidePShadow: isP1,
            hideEShadow: !isP1,
            loomingShadow: { offsetY: 0, w: 62, h: 20, alpha: 0.85 },
            isHighSkyCutscene: false,
            isAttackerPlayer: isP1,
            showEffect: false,
            hitFlash: false,
          ...
          // 2. High Sky Gliding Cutscene (66ms x 4 = 264ms)
          {
            delay: 66,
            pOffset: { x: -4, y: -6 },
            eOffset: { x: -4, y: -6 },
          ...
          },
          {
            ...
            pOffset: { x: -3, y: -4 },
            eOffset: { x: -3, y: -4 },
            pScale: isP1 ? { x: 1.04, y: 0.96 } : undefined,
            eScale: !isP1 ? { x: 1.04, y: 0.96 } : undefined,
            pRot: isP1 ? -0.03 : 0,
            eRot: !isP1 ? -0.03 : 0,
            isHighSkyCutscene: true,
            isAttackerPlayer: isP1,
          ...
          },
          {
            ...
            pOffset: { x: 2, y: 6 },
            eOffset: { x: 2, y: 6 },
            pScale: isP1 ? { x: 0.98, y: 1.02 } : undefined,
            eScale: !isP1 ? { x: 0.98, y: 1.02 } : undefined,
            pRot: isP1 ? 0.02 : 0,
            eRot: !isP1 ? 0.02 : 0,
            isHighSkyCutscene: true,
            isAttackerPlayer: isP1,
          ...
          // 3. Descending Dive-Bomb on Target (스프라이트가 흔들리면서 커짐! 66ms x 4 = 264ms)
          {
            delay: 66,
            pOffset: isP1 ? { x: 262, y: -345 } : { x: 0, y: 0 },
            eOffset: !isP1 ? { x: -262, y: -55 } : { x: 0, y: 0 },
            pScale: isP1 ? { x: 0.55, y: 0.75 } : undefined,
            eScale: !isP1 ? { x: 0.55, y: 0.75 } : undefined,
            pRot: isP1 ? -0.08 : 0,
            eRot: !isP1 ? -0.08 : 0,
            loomingShadow: { offsetY: 0, w: 42, h: 14, alpha: 0.70 },
            isHighSkyCutscene: false,
            isAttackerPlayer: isP1,
            showEffect: false,
            hitFlash: false,
          ...
          {
            delay: 66,
            pOffset: isP1 ? { x: 274, y: -275 } : { x: 0, y: 0 },
            eOffset: !isP1 ? { x: -274, y: 15 } : { x: 0, y: 0 },
            pScale: isP1 ? { x: 0.95, y: 1.15 } : undefined,
            eScale: !isP1 ? { x: 0.95, y: 1.15 } : undefined,
            pRot: isP1 ? 0.08 : 0,
            eRot: !isP1 ? 0.08 : 0,
            loomingShadow: { offsetY: 0, w: 58, h: 18, alpha: 0.85 },
            isHighSkyCutscene: false,
            isAttackerPlayer: isP1,
            showEffect: false,
            hitFlash: false,
          ...
          {
            delay: 66,
            pOffset: isP1 ? { x: 265, y: -205 } : { x: 0, y: 0 },
            eOffset: !isP1 ? { x: -265, y: 85 } : { x: 0, y: 0 },
            pScale: isP1 ? { x: 1.40, y: 1.45 } : undefined,
            eScale: !isP1 ? { x: 1.40, y: 1.45 } : undefined,
            pRot: isP1 ? -0.04 : 0,
            eRot: !isP1 ? -0.04 : 0,
            loomingShadow: { offsetY: 0, w: 72, h: 22, alpha: 0.95 },
            isHighSkyCutscene: false,
            isAttackerPlayer: isP1,
            showEffect: false,
            hitFlash: false,
          ...
          {
            delay: 66,
            pOffset: isP1 ? { x: 268, y: -155 } : { x: 0, y: 0 },
            eOffset: !isP1 ? { x: -268, y: 135 } : { x: 0, y: 0 },
            pScale: isP1 ? { x: 1.80, y: 1.70 } : undefined,
            eScale: !isP1 ? { x: 1.80, y: 1.70 } : undefined,
            pRot: 0,
            eRot: 0,
            isHighSkyCutscene: false,
            isAttackerPlayer: isP1,
          ...
          // 4. Ground Arena Vertical Dive-Bomb Impact Slam (66ms x 3 = 200ms)
          {
            ...
            eOffset: isP1 ? (isMiss1 ? { x: 20, y: -4 } : { x: 8, y: -4 }) : { x: -268, y: 151 },
            pScale: isP1 ? { x: 1.40, y: 0.65 } : undefined,
            eScale: !isP1 ? { x: 1.40, y: 0.65 } : undefined,
            pRot: 0,
            eRot: 0,
            pWhite: false,
            eWhite: false,
          ...
          },
          {
            ...
            pScale: isP1 ? { x: 1.15, y: 0.90 } : undefined,
            eScale: !isP1 ? { x: 1.15, y: 0.90 } : undefined,
            isHighSkyCutscene: false,
            showEffect: true,
            hitFlash: false,
            enemyHp: a1.enemyHpAfter,
      ...
      if (isTurn1Launch) {
        ...
        act2Frames = [
          ...
          },
          {
            ...
            pOffset: { x: -3, y: -4 },
            eOffset: { x: -3, y: -4 },
            pScale: isP2 ? { x: 1.04, y: 0.96 } : undefined,
            eScale: !isP2 ? { x: 1.04, y: 0.96 } : undefined,
            pRot: isP2 ? -0.03 : 0,
            eRot: !isP2 ? -0.03 : 0,
            isHighSkyCutscene: true,
            isAttackerPlayer: isP2,
          ...
          },
          {
            ...
            pOffset: { x: 2, y: 6 },
            eOffset: { x: 2, y: 6 },
            pScale: isP2 ? { x: 0.98, y: 1.02 } : undefined,
            eScale: !isP2 ? { x: 0.98, y: 1.02 } : undefined,
            pRot: isP2 ? 0.02 : 0,
            eRot: !isP2 ? 0.02 : 0,
            isHighSkyCutscene: true,
            isAttackerPlayer: isP2,
          ...
          {
            delay: 66,
            pOffset: isP2 ? { x: 262, y: -345 } : { x: 0, y: 0 },
            eOffset: !isP2 ? { x: -262, y: -55 } : { x: 0, y: 0 },
            pScale: isP2 ? { x: 0.55, y: 0.75 } : undefined,
            eScale: !isP2 ? { x: 0.55, y: 0.75 } : undefined,
            pRot: isP2 ? -0.08 : 0,
            eRot: !isP2 ? -0.08 : 0,
            loomingShadow: { offsetY: 0, w: 42, h: 14, alpha: 0.70 },
            isHighSkyCutscene: false,
          ...
          {
            delay: 66,
            pOffset: isP2 ? { x: 274, y: -275 } : { x: 0, y: 0 },
            eOffset: !isP2 ? { x: -274, y: 15 } : { x: 0, y: 0 },
            pScale: isP2 ? { x: 0.95, y: 1.15 } : undefined,
            eScale: !isP2 ? { x: 0.95, y: 1.15 } : undefined,
            pRot: isP2 ? 0.08 : 0,
            eRot: !isP2 ? 0.08 : 0,
            loomingShadow: { offsetY: 0, w: 58, h: 18, alpha: 0.85 },
            isHighSkyCutscene: false,
          ...
          {
            delay: 66,
            pOffset: isP2 ? { x: 265, y: -205 } : { x: 0, y: 0 },
            eOffset: !isP2 ? { x: -265, y: 85 } : { x: 0, y: 0 },
            pScale: isP2 ? { x: 1.40, y: 1.45 } : undefined,
            eScale: !isP2 ? { x: 1.40, y: 1.45 } : undefined,
            pRot: isP2 ? -0.04 : 0,
            eRot: !isP2 ? -0.04 : 0,
            loomingShadow: { offsetY: 0, w: 72, h: 22, alpha: 0.95 },
            isHighSkyCutscene: false,
          ...
          {
            delay: 66,
            pOffset: isP2 ? { x: 268, y: -155 } : { x: 0, y: 0 },
            eOffset: !isP2 ? { x: -268, y: 135 } : { x: 0, y: 0 },
            pScale: isP2 ? { x: 1.80, y: 1.70 } : undefined,
            eScale: !isP2 ? { x: 1.80, y: 1.70 } : undefined,
            pRot: 0,
            eRot: 0,
            isHighSkyCutscene: false,
            isAttackerPlayer: isP2,
          ...
          // 4. Ground Arena Vertical Dive-Bomb Impact Slam (66ms x 3 = 200ms)
          {
            ...
            eOffset: isP2 ? (isMiss2 ? { x: 20, y: -4 } : { x: 8, y: -4 }) : { x: -268, y: 151 },
            pScale: isP2 ? { x: 1.40, y: 0.65 } : undefined,
            eScale: !isP2 ? { x: 1.40, y: 0.65 } : undefined,
            pRot: 0,
            eRot: 0,
            pWhite: false,
            eWhite: false,
          ...
          },
          {
            ...
            pScale: isP2 ? { x: 1.15, y: 0.90 } : undefined,
            eScale: !isP2 ? { x: 1.15, y: 0.90 } : undefined,
            isHighSkyCutscene: false,
            showEffect: true,
            hitFlash: false,
            enemyHp: a2.enemyHpAfter,
