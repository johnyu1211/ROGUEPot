...
import { drawFirePunchEffect } from "../../../renderers/moves/gen1/move005_008.js";

export const firePunchMove: BattleMoveAnimation = {
  num: 7,
  key: "fire-punch",
  nameKo: "불꽃펀치",
  nameEn: "Fire Punch",
  ...
  drawEffect: (targetCtx: any, frame: BattleFrame, drawCtx: EffectDrawContext) => {
    if (frame.showEffect && drawCtx.targetPos) {
      drawFirePunchEffect(targetCtx, drawCtx.targetPos, frame.moveStep ?? 3);
    }
  }
};
