...
import { drawIcePunchEffect } from "../../../renderers/moves/gen1/move005_008.js";

export const icePunchMove: BattleMoveAnimation = {
  num: 8,
  key: "ice-punch",
  nameKo: "냉동펀치",
  nameEn: "Ice Punch",
  ...
  drawEffect: (targetCtx: any, frame: BattleFrame, drawCtx: EffectDrawContext) => {
    if (frame.showEffect && drawCtx.targetPos) {
      drawIcePunchEffect(targetCtx, drawCtx.targetPos, frame.moveStep ?? 3);
    }
  }
};
