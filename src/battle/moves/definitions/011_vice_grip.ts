...
import { drawViceGripEffect } from "../../../renderers/moves/gen1/move009_012.js";

export const viceGripMove: BattleMoveAnimation = {
  num: 11,
  key: "vice-grip",
  nameKo: "찝기",
  nameEn: "Vice Grip",
  ...
  drawEffect: (targetCtx: any, frame: BattleFrame, drawCtx: EffectDrawContext) => {
    if (frame.showEffect && drawCtx.targetPos) {
      drawViceGripEffect(targetCtx, drawCtx.targetPos, frame.moveStep ?? 1);
    }
  }
};
