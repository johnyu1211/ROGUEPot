 ...
 * 132: 휘감기 (Constrict)
 * 
 * [유저 요구사항: "휘감기는 김밥말이 그대로 가져와봐"]:
 * 035 김밥말이(Wrap)의 똬리 돌돌 말기 + 피격자 회전 뒤집힘 + 전신 압박 클램프 연출 100% 동일 적용
 */
export const constrictMove: BattleMoveAnimation = {
  num: 132,
  key: "constrict",
  nameKo: "휘감기",
  nameEn: "Constrict",
  ...
  buildFrames: (ctx: MoveContext): BattleFrame[] => {
    ...
    return [
      ...
      // 2. 전면 회전 감기 (80ms)
      {
        ...
        moveEffect: a,
        moveStep: 2,
        phaseId: "constrict-roll-front",
        phaseName: "2. 전면 회전 감기",
      },
      // 3. 후면 회전 (80ms) - [돌돌 마는 기술이므로 피격자 뒤집힘]
      {
        delay: 80,
      ...
      // 4. 전신 압박 작렬 (160ms) - 강력한 압축 클램프 및 타격 이펙트
      {
        ...
        moveEffect: a,
        moveStep: 4,
        phaseId: "constrict-clamp",
        phaseName: "4. 휘감기 조이기 압박 작렬",
      },
      // 5. 펄스 조임 유지 (90ms)
      {
        delay: 90,
