    ...
    try {
      ...
      const sessionNoticeEmbed = new EmbedBuilder()
        ...
        .setDescription(
          ...
          (isKo
            ? "⚠️ **데이터 및 세션 유실 면책 고지**\n" +
              "• 봇 업데이트/재부팅, 디스코드 상호작용 세션 만료(15분) 및 서버 점검 등으로 인해 진행 중이던 게임 데이터나 배틀 세션이 유실될 수 있으며, 이에 대해 개발자는 일절 책임을 지지 않습니다.\n" +
            ...
            : "⚠️ **Data & Session Loss Disclaimer**\n" +
              "• The developer assumes NO responsibility for any loss of game progress or active battle sessions caused by bot updates, restarts, Discord session timeouts (15m), or server downtime.\n" +
