...
exports.GENERATION_INFO = exports.DEFAULT_MAX_COST = exports.STARTER_DATABASE = void 0;
exports.getStartersByGen = getStartersByGen;
exports.getStarterByDexNumber = getStarterByDexNumber;
exports.getStarterBySpeciesId = getStarterBySpeciesId;
exports.STARTER_DATABASE = [
    // Generation 1 (Kanto)
    {
...
exports.DEFAULT_MAX_COST = 10;
exports.GENERATION_INFO = [
...
function getStartersByGen(gen) {
    if (gen <= 0)
        return exports.STARTER_DATABASE;
    return exports.STARTER_DATABASE.filter(function (s) { return s.gen === gen; });
}
/**
 * Get starter entry by Dex Number
 */
function getStarterByDexNumber(dexNo) {
    return exports.STARTER_DATABASE.find(function (s) { return s.dexNumber === dexNo; });
}
/**
 * Get starter entry by Species ID
 */
function getStarterBySpeciesId(speciesId) {
    if (!speciesId)
        return undefined;
    var clean = speciesId.toLowerCase().replace(/[\s_]+/g, "-");
    return exports.STARTER_DATABASE.find(function (s) { return s.speciesId.toLowerCase() === clean; });
}
